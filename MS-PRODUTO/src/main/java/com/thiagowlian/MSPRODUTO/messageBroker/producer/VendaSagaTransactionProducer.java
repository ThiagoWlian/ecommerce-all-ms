...
public class VendaSagaTransactionProducer {
    ...
    public void producerVendaFeedbackError(VendaFeedbackDto vendaFeedbackDto) {
        rabbitTemplate.convertAndSend(VENDAS_REALIZAR_VENDA_CHOREOGRAPHY_EXCHANGE, VENDA_FEEDBACK_ERRO_ROUTING_KEY, vendaFeedbackDto);
    }
